...
import { ActivitySquare, Mail, Phone, MapPin, Shield } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center space-x-2">
              <ActivitySquare className="h-6 w-6 text-primary-400" />
              <span className="text-lg font-semibold text-white">OncoSense</span>
            </div>
            <p className="mt-4 text-sm">
              AI-driven early cancer detection and screening platform, empowering individuals to take control of their health.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link to="/mobile" className="text-gray-300 hover:text-white">Mobile App</Link>
              </li>
              <li>
                <Link to="/sensespot" className="text-gray-300 hover:text-white">SenseSpot Pod</Link>
              </li>
              <li>
                <Link to="/corporate" className="text-gray-300 hover:text-white">Corporate Solutions</Link>
              </li>
              <li>
                <Link to="/ai" className="text-gray-300 hover:text-white">Our AI Technology</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start space-x-3">
                ...
                <span>123 Health Street, Singapore 123456</span>
              </li>
